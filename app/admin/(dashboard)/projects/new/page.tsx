...
export default function NewProjectPage() {
  ...
  const addToArray = (field: keyof Pick<ProjectFormData, 'techStack' | 'features' | 'challenges' | 'results' | 'images'>, itemKey: keyof typeof newItem) => {
  ...
  const removeFromArray = (field: keyof Pick<ProjectFormData, 'techStack' | 'features' | 'challenges' | 'results' | 'images'>, index: number) => {
    setFormData({
      ...formData,
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-stone-100">New Project</h1>
          <p className="text-stone-400 mt-1">Add a new project to your portfolio</p>
        </div>
      </div>
